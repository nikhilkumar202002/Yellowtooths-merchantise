    ...
    return (
        <section className="crafted-cinema py-10 md:py-20">
            <div className="crafted-cinema-container content-container">
                ...
                <div className="crafted-cinema-header grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 items-end mb-6 md:mb-10">
                ...
                <div className="crafted-cinema-wrapper grid grid-cols-1 lg:grid-cols-[42%_58%] gap-4 md:gap-5 items-stretch">
                    
                    {/* LEFT COLUMN */}
                    <div className="crafted-cinema-left flex flex-col h-full">
                        {/* Reduced margin below buttons for mobile */}
                        <div className="crafted-cinema-left-btns flex flex-wrap gap-3 w-full mb-4 md:mb-6">
                        ...
                        <div className="crafted-cinema-left-img relative min-h-[350px] md:min-h-[450px] lg:flex-grow rounded-[25px] overflow-hidden group">
                            <Image 
                                src={Imageone} 
                                alt="Movie T-Shirts" 
                                fill 
                    ...
                    {/* RIGHT COLUMN */}
                    <div className="crafted-cinema-right grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
                        
                        {/* Sub-column 1 */}
                        <div className="flex flex-col gap-4 md:gap-5 h-full">
                            <div className="relative min-h-[250px] md:min-h-[300px] flex-grow rounded-[25px] overflow-hidden group">
                                <Image 
                                    src={Imagetwo} 
                                    alt="Fibre Frames" 
                                    fill 
                            ...
                            {/* Promo Box */}
                            <div className="bg-yellow p-6 md:p-8 rounded-[25px] flex flex-col justify-between min-h-[180px] md:min-h-[220px] shadow-sm">
                                <div>
                                    <h4 className="font-manrope font-bold uppercase text-[10px] tracking-[0.2em] text-dark/60">Limited Drop</h4>
                                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-moralana text-dark leading-tight mt-2">Save 15% on New Merch</h2>
                                </div>
                        ...
                        {/* Sub-column 2 */}
                        <div className="relative min-h-[300px] md:min-h-[400px] sm:h-full rounded-[25px] overflow-hidden group">
                            <Image 
                                src={Imagethree} 
                                alt="Sculptures" 
                                fill 
                            ...
                            <div className="z-10 p-6 absolute bottom-0 left-0 right-0">
                                ...
                                <h5 className="hidden md:block text-gray-100 font-manrope text-sm mt-2 drop-shadow-md">Handcrafted fibre sculptures inspired by characters.</h5>
                            </div>
                        </div>
                    </div>
